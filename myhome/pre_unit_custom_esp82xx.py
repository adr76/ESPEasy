...
env.Append(CPPDEFINES=[
  #"BUILD_GIT='Outdoor-light-unit'",
	...
	"USES_P005",  # DHT 11/22
	#"USES_P010",  # BH1750
  #"USES_P011",  # Pro Mini Extender
	#"USES_P019",  # PCF8574
	#"USES_P020",  # Ser2Net
	"USES_P021",   # Level Control
  "USES_P023",   # OLED SSD1306 display
	#"USES_P025",  # ADS1115
	"USES_P026",  # SysInfo
	"USES_P028",  # BME280
	"USES_P029",  # Output
	#"USES_P031",  # SHT1X
	#"USES_P036",  # OLED SSD1306 display
	"USES_P037",  # MQTTImport
	#"USES_P049",  # MHZ19
	#"USES_P052",  # SenseAir
	#"USES_P056",  # SDS011-Dust
	#"USES_P059",  # Encoder
	#"USES_P061",  # PCF8574/MCP23017 KeyPad 
  ...
  #"USES_P089",  # ICMP Ping probing
  #"USES_P091",  # Serial MCU controlled switch
  #"USES_P171",  # PZEM-004T AC meter, use v2.4.2 of the esp8266 board lib.

  # RF433  
	"USES_P111",  # RF Input
	#"USES_P112",  # RF Output

	#"USES_C001",   # Domoticz HTTP
