...
#define BUILD_GIT           "test-unit: "  __DATE__ " "  __TIME__


#define DEFAULT_NAME        "test-unit"                        // Enter your device friendly name
...
// --- Wifi Client Mode -----------------------------------------------------------------------------
#define DEFAULT_SSID                         "ASUS"            // Enter your network SSID
#define DEFAULT_KEY                          "28081976" // Enter your network WPA key
#define DEFAULT_USE_STATIC_IP                false                   // (true|false) enabled or disabled static IP
#define DEFAULT_IP                           "192.168.1.201"          // Enter your IP address
...
#define DEFAULT_CONTROLLER_USER    "unit"                                   // Default controller user
#define DEFAULT_CONTROLLER_PASS    "unit"                                   // Default controller Password

// using a default template, you also need to set a DEFAULT PROTOCOL to a suitable MQTT protocol !
#define DEFAULT_PUB         "myhome/%sysname%/%tskname%/%valname%" 			// Enter your pub
#define DEFAULT_SUB         "myhome/%sysname%/#"                   			// Enter your sub
#define DEFAULT_SERVER      "192.168.1.1"                          			// Enter your Server IP address
#define DEFAULT_SERVER_HOST "asus"                                 			// Server hostname
...
#define DEFAULT_MQTT_LWT_TOPIC                  "myhome/%sysname%/state"                // Default lwt topic
